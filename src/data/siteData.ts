export const siteData = {
  ...
  website: "https://shaw-dev.vercel.app/",
  social: {
...
export const testimonials = [
  {
    ...
    content: "West Fitness has completely transformed my fitness journey. The trainers are amazing and the community is so supportive!",
    rating: 5,
  },
  {
    name: "Mike Chen",
...
export const successStories = [
  {
    ...
    duration: "8 months",
    result: "Lost 45 lbs",
    story: "I was skeptical at first, but West Fitness changed my life. The supportive trainers and community kept me motivated. I've never felt better!",
  ...
  },
  {
    ...
    story: "From never running to completing a marathon - West Fitness's cardio programs and group classes gave me the endurance and confidence I needed.",
...
export const history = [
  {
    year: "2009",
    title: "Founded",
    description: "West Fitness was founded with a vision to create an inclusive fitness community where everyone feels welcome.",
  },
  {
    year: "2012",
